<template>
	<div>
     ...
     <v-dialog v-model="dialogAdd" max-width="500px" >
  		 <v-btn dark color="red darken-2"  slot="activator" >Agregar Asignatura</v-btn>
  		 ...
  		 <v-card>
  			 ...
  			 <v-card-text>
  				 <v-container grid-list-md>
  					 <v-layout wrap>
  						 <v-flex xs12>
  							 <v-text-field label="Nombre Asignatura" :counter="20" :rules="textoRules" ref="txtNombre" id="nombreSeccion"  required></v-text-field>
  						 </v-flex>
							 <v-flex xs12>
								 <v-text-field label="Nombre Seccion" :counter="20" :rules="textoRules" ref="txtNombre" id="nombreSeccion"  required></v-text-field>
							 </v-flex>
							 <v-flex xs12>
								 <v-text-field label="Nombre Docente" :counter="20" :rules="textoRules" ref="txtNombre" id="nombreSeccion"  required></v-text-field>
							 </v-flex>
  					 </v-layout>
  				 </v-container>
  			 </v-card-text>
